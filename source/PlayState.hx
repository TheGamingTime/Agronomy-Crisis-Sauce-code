...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['Worse than your entire family together', 0.2], //From 0% to 19%
		['among us', 0.4], //From 20% to 39%
		['barf', 0.5], //From 40% to 49%
		['Worse than average', 0.6], //From 50% to 59%
		['Meh', 0.69], //From 60% to 68%
		['Why is this a rating', 0.7], //69%
		['Bambu approved', 0.8], //From 70% to 79%
		['Nice', 0.9], //From 80% to 89%
		['Spookdu Approves!', 1], //From 90% to 99%
		['Epik!!', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
